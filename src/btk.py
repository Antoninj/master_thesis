...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_btk')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_btk')
...
class btkC3DFileIO(btkAcquisitionFileIO):
    ...
    def SetPointScale(self, s):
        ...
        """
        return _btk.btkC3DFileIO_SetPointScale(self, s)
    ...
    def SetAnalogIntegerFormat(self, f):
        """
        SetAnalogIntegerFormat(self, f)

        Sets the integer format used to store analog channels data.
        """
        return _btk.btkC3DFileIO_SetAnalogIntegerFormat(self, f)
